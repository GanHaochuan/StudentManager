...
void drawSierpinskiTriangle(GWindow& window,
    ...
    drawSierpinskiTriangle(window,x0,y0,mx0,my0,mx2,my2,order-1);
    drawSierpinskiTriangle(window,mx0,my0,x1,y1,mx1,my1,order-1);
    drawSierpinskiTriangle(window,mx2,my2,mx1,my1,x2,y2,order-1);
