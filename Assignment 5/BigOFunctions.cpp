...
Part 2: Counting Triples
countTriples O(n³)


Part 3: Printing Cycles
printCycle_v1 O(n²)
printCycle_v2 O(n²)
printCycle_v3 O(n)


Part 4: Recursive Mysteries
recursivePuzzle O(n)
recursiveEnigma O(log n)

Part 5: Maximum Single-Sell Profit
maximumSingleSellProfit_v1 O(n²)
maximumSingleSellProfit_v2 O(n log n)
*/
